...
INSERT INTO users (user_id, username, password_hash, role, status, store_id, balance, phone_number, created_at) VALUES
                                                                                                                    (1, 'admin_super', 'hash_admin_123', 'ADMIN', 'NORMAL', NULL, 0.00, '13800000000', '2026-04-01 09:00:00'),
                                                                                                                    (2, 'emp_bj_01', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 1, 0.00, '13800000001', '2026-04-02 08:00:00'),
                                                                                                                    (3, 'emp_bj_02', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 2, 0.00, '13800000002', '2026-04-02 08:00:00'),
                                                                                                                    (4, 'emp_bj_03', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 3, 0.00, '13800000003', '2026-04-02 08:00:00'),
                                                                                                                    (5, 'emp_bj_04', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 4, 0.00, '13800000004', '2026-04-02 08:00:00'),
                                                                                                                    (6, 'emp_bj_05', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 5, 0.00, '13800000005', '2026-04-02 08:00:00'),
                                                                                                                    (7, 'emp_sh_01', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 6, 0.00, '13800000006', '2026-04-02 08:00:00'),
                                                                                                                    (8, 'emp_sh_02', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 7, 0.00, '13800000007', '2026-04-02 08:00:00'),
                                                                                                                    (9, 'emp_gz_01', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 8, 0.00, '13800000008', '2026-04-02 08:00:00'),
                                                                                                                    (10, 'emp_gz_02', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 9, 0.00, '13800000009', '2026-04-02 08:00:00'),
                                                                                                                    (11, 'emp_sz_01', 'hash_emp_123', 'EMPLOYEE', 'NORMAL', 10, 0.00, '13800000010', '2026-04-02 08:00:00'),
                                                                                                                    (12, 'user_alice', 'hash_usr_123', 'CONSUMER', 'NORMAL', NULL, 500.00, '13900000001', '2026-04-10 10:00:00'),
                                                                                                                    (13, 'user_bob', 'hash_usr_123', 'CONSUMER', 'NORMAL', NULL, 20.50, '13900000002', '2026-04-11 11:00:00'),
                                                                                                                    (14, 'user_charlie', 'hash_usr_123', 'CONSUMER', 'NORMAL', NULL, 300.00, '13900000003', '2026-04-12 12:00:00'),
                                                                                                                    (15, 'user_diana', 'hash_usr_123', 'CONSUMER', 'NORMAL', NULL, 150.00, '13900000004', '2026-04-12 14:00:00'),
                                                                                                                    (16, 'user_eve', 'hash_usr_123', 'CONSUMER', 'BANNED', NULL, 0.00, '13900000005', '2026-04-13 09:00:00');
